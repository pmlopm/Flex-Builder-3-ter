package myComponents
{
    ...
    public class PrefTreeDataDescriptor extends DefaultDataDescriptor implements ITreeDataDescriptor
    {
        ...
        public function PrefTreeDataDescriptor()
        {
        	nameSort = new Sort();
...
//	      var collection:XMLListCollection = new XMLListCollection((node as XML).(attribute("isVisible")=='true').application)

	      var collection:XMLListCollection = new XMLListCollection((node as XML).application.(@isVisible=='true'))
